...
const s = {
  ...
  filterCount: { fontSize:10, background:"rgba(251,245,234,0.2)", padding:"1px 5px", borderRadius:10 },
  ...
  threadItemActive: { background:"var(--color-amber-tint)" },
  ...
  threadList: { fontSize:10, color:"var(--color-accent-amber-deep)", fontWeight:600, background:"var(--color-amber-tint)", padding:"1px 7px", borderRadius:10, display:"inline-block", marginBottom:3 },
  ...
  headerListTag: { background:"var(--color-amber-tint)", color:"var(--color-accent-amber-deep)", fontSize:10, fontWeight:600, padding:"2px 8px", borderRadius:10, marginLeft:6 },
  ...
  spinnerWhite: { display:"inline-block", width:14, height:14, border:"2px solid rgba(251,245,234,0.3)", borderTopColor:"var(--color-ground-page)", borderRadius:"50%", animation:"spin 0.7s linear infinite" },
};
